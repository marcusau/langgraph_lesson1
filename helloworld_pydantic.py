...
class HellowWorldState(BaseModel):
    message: str = Field(description="The message to be printed",min_length=3,max_length=100)
    id: Optional[int] = Field(description="The id of the message",default=None)
## step 2: define nodes
...
output = runnable.invoke({"message": "Marcus",})## id is optional
print(output)
